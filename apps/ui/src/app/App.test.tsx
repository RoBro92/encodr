          ...
          items: [
            {
              ...
              analysis_payload: {
                ...
                confidence: "high",
                is_protected: false,
                reason_codes: ["video_reduction_limit_applies"],
                reason_messages: ["Compression safety will be checked after encoding using video-only reduction and bitrate safeguards."],
                warning_codes: [],
                warning_messages: [],
                ...
                source_video_bitrate_bps: 9500000,
                estimated_output_video_bitrate_bps: 6840000,
                target_crf: 21,
                low_bitrate_skip_threshold_bps: 3000000,
                minimum_output_bitrate_bps: 1750000,
