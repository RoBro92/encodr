...
function storageStatus({
  ...
  return {
    ...
    scratch: {
      ...
      is_mount: scratchStatus === "healthy",
      readable: scratchStatus === "healthy",
      writable: scratchStatus === "healthy",
      same_filesystem_as_root: scratchStatus === "healthy" ? false : null,
      entry_count: scratchStatus === "healthy" ? 0 : null,
    ...
    media_mounts: [{
      ...
      same_filesystem_as_root: false,
      entry_count: status === "healthy" ? 12 : 0,
      total_space_bytes: 2_000_000_000,
      free_space_bytes: 1_000_000_000,
      free_space_ratio: 0.5,
    }],
